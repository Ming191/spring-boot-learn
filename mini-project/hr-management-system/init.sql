...
-- Index tìm kiếm theo username khi login (MyBatis selectByUsername)
CREATE INDEX idx_users_username ON users (username);
CREATE INDEX idx_users_role     ON users (role);

-- Sample data — password là BCrypt của "password123"
...
-- Index thường dùng trong Dynamic SQL search
...
-- Sample employees (auth_user_id khớp với id trong db_auth.users)
...
-- Gán trưởng phòng sau khi có employee
...
-- Index thường dùng: lọc theo nhân viên, trạng thái, khoảng ngày
...
-- Composite index cho query "tìm đơn PENDING của phòng X"
